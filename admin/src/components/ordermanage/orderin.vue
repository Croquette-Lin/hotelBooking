  ...
  <div>
      ...
      >
        ...
        <el-table-column label="操作" width="160" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="danger" @click="checkout(scope.$index, scope.row)">退房</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <el-dialog title="提示" :visible.sync="delDialogVisible" width="30%">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="doOut">确定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    _getlist() {
      this.$http.get("/api/order/getinList").then(response => {
